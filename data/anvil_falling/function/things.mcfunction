...
execute at @a if dimension minecraft:overworld run setblock ~ ~100 ~ minecraft:anvil
...
execute at @a if dimension minecraft:the_nether run fill ~ 127 ~ ~ 120 ~ air replace minecraft:bedrock
execute at @a if dimension minecraft:the_nether run setblock ~ 130 ~ minecraft:anvil
...
execute at @a if dimension minecraft:the_end run setblock ~ ~100 ~ minecraft:anvil
